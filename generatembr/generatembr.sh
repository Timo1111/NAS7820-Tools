...
STAGE1_LENGTH=32768    # minus half for the rom bug

# Actual generation

STAGE1_PRIMARY_CHKSUM=$((STAGE1_PRIMARY_STARTSECTOR+STAGE1_LENGTH))
STAGE1_SECONDARY_CHKSUM=$((STAGE1_SECONDARY_STARTSECTOR+STAGE1_LENGTH))
...
VAL_STRING="\0$VAL_OCTAL0H$VAL_OCTAL0M$VAL_OCTAL0L"
VAL_STRING="$VAL_STRING\0$VAL_OCTAL1H$VAL_OCTAL1M$VAL_OCTAL1L"
VAL_STRING="$VAL_STRING\0$VAL_OCTAL2H$VAL_OCTAL2M$VAL_OCTAL2L"
VAL_STRING="$VAL_STRING\0$VAL_OCTAL3H$VAL_OCTAL3M$VAL_OCTAL3L"
