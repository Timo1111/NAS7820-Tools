...
STAGE1_SECTOR_LENGTH=128    # minus half for the rom bug

STAGE1_PRIMARY_CHKSUM=$((STAGE1_PRIMARY_STARTSECTOR+STAGE1_SECTOR_LENGTH))
STAGE1_SECONDARY_CHKSUM=$((STAGE1_SECONDARY_STARTSECTOR+STAGE1_SECTOR_LENGTH))
